...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Editar Emergencia</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('emergencias.update', $emergencia) }}" method="POST" id="formEmergencia">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="hora_salida_emergencia" class="form-control @error('hora_salida_emergencia') is-invalid @enderror" value="{{ old('hora_salida_emergencia', $emergencia->hora_salida_emergencia) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="hora_llegada_emergencia" class="form-control @error('hora_llegada_emergencia') is-invalid @enderror" value="{{ old('hora_llegada_emergencia', $emergencia->hora_llegada_emergencia) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="hora_en_base" class="form-control @error('hora_en_base') is-invalid @enderror" value="{{ old('hora_en_base', $emergencia->hora_en_base) }}" required>
                                @error('hora_en_base')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipo_incidente_id" class="form-control @error('tipo_incidente_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($incidentes as $incidente)
                                        <option value="{{ $incidente->id }}" {{ old('tipo_incidente_id', $emergencia->tipo_incidente_id) == $incidente->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="subcategoria" class="form-control @error('subcategoria') is-invalid @enderror" value="{{ old('subcategoria', $emergencia->subcategoria) }}" placeholder="Ej: Estructural, Vehicular, etc.">
                                @error('subcategoria')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="estacion_id" class="form-control @error('estacion_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($estaciones as $estacion)
                                        <option value="{{ $estacion->id }}" {{ old('estacion_id', $emergencia->estacion_id) == $estacion->id ? 'selected' : '' }}>
                                            {{ $estacion->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="direccion" class="form-control" required
                                    value="{{ old('direccion', $emergencia->direccion) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="referencia" class="form-control"
                                    value="{{ old('referencia', $emergencia->referencia) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ciudadano_afectado" class="form-control @error('ciudadano_afectado') is-invalid @enderror" value="{{ old('ciudadano_afectado', $emergencia->ciudadano_afectado) }}" placeholder="Nombre del ciudadano afectado">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="informacion_inicial" class="form-control @error('informacion_inicial') is-invalid @enderror" rows="2" required>{{ old('informacion_inicial', $emergencia->informacion_inicial) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="detalle_emergencia" class="form-control @error('detalle_emergencia') is-invalid @enderror" rows="3" required>{{ old('detalle_emergencia', $emergencia->detalle_emergencia) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="danos_estimados" class="form-control @error('danos_estimados') is-invalid @enderror" value="{{ old('danos_estimados', $emergencia->danos_estimados) }}" placeholder="Ej: $10,000, Daños estructurales, etc.">
                            ...
                            <div class="form-group">
                                ...
                                <select name="usuarios[]" class="form-control select2" multiple style="width: 100%;">
                                    @foreach($usuarios as $usuario)
                                        <option value="{{ $usuario->id }}" {{ $emergencia->usuarios->contains($usuario->id) ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="vehiculos[{{ $key }}][vehiculo_id]" class="form-control">
                                                        ...
                                                        @foreach($vehiculos as $v)
                                                            <option value="{{ $v->id }}" {{ $vehiculo->id == $v->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="vehiculos[{{ $key }}][conductor_id]" class="form-control">
                                                        <option value="">Seleccione...</option>
                                                        @foreach($usuarios as $usuario)
                                                            <option value="{{ $usuario->id }}" {{ $vehiculo->pivot->conductor_id == $usuario->id ? 'selected' : '' }}>
                                                                {{ $usuario->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="vehiculos[{{ $key }}][km_salida]" class="form-control" value="{{ $vehiculo->pivot->km_salida ?? '' }}" placeholder="KM">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>KM Retorno</label>
                                                    <input type="number" name="vehiculos[{{ $key }}][km_retorno]" class="form-control" value="{{ $vehiculo->pivot->km_retorno ?? '' }}" placeholder="KM">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
...
<script>
let vehiculoCount = {{ $emergencia->vehiculos->count() }};
