...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <a href="{{ route('reportes.emergencias.pdf', ['fecha_desde' => $fechaDesde, 'fecha_hasta' => $fechaHasta]) }}" class="btn btn-danger btn-sm" target="_blank">
                <i class="fas fa-file-pdf"></i> Exportar PDF
            </a>
            <a href="{{ route('reportes.emergencias') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ date('d/m/Y', strtotime($fechaDesde)) }}<br>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const labels = @json($datosGrafico->pluck('nombre_incidente'));
    const data = @json($datosGrafico->pluck('total'));
    ...
    const fechas = @json($datosBarras->pluck('fecha'));
    const totales = @json($datosBarras->pluck('total'));
