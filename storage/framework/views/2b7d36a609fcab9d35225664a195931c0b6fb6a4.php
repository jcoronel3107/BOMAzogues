...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="<?php echo e(asset('images/favicon_192x192.png')); ?>">
    <link rel="shortcut icon" sizes="192x192" href="<?php echo e(asset('images/favicon_192x192.png')); ?>">
	
	<!-- Custom fonts for this template-->
	<link href="<?php echo e(asset('vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo e(asset('css/sb-admin-2.min.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('css/varios.css')); ?>" rel="stylesheet">
	...
	<link href="<?php echo e(asset('vendor/fullcalendar/daygrid/main.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('vendor/fullcalendar/core/main.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('vendor/fullcalendar/list/main.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('vendor/fullcalendar/timeline/main.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('vendor/fullcalendar/timegrid/main.css')); ?>" rel="stylesheet">
...
<body onload="startTime()" id="page-top">
	...
	<div id="wrapper">
		<?php echo $__env->yieldContent("cabeza"); ?>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<!-- End of Main Content -->
			<?php echo $__env->yieldContent("piepagina"); ?>
	...
	<script defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_API_KEY')); ?>&callback=initMap"></script>
	...
	<script src="<?php echo e(asset('vendor/fullcalendar/timeline/main.js')); ?>"></script>
	<script src="<?php echo e(asset('js/Clima.js')); ?>"></script>
