...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control <?php $__errorArgs = ['rol_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="cargo" require>
                                        <option value="<?php echo e(old('cargo')); ?>" selected>Choose...</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                                <label for="rol" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Status')); ?></label>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desarrollo\htdocs\resources\views/auth/register.blade.php ENDPATH**/ ?>